...
<body>
    <header>
        <nav>
            <a href= "iniciosesion.html" class="line_animation"> Empleados </a>
        ...
        <section class = "textos-header">
            ...
            <h2> Centro de la conservacion ambiental </h2>
        </section>
    ...
    <main>
        ...
        <section class = "about-services" id="ANIMALES">
        ...
        <section class="info" id="INFO">
            <div class="texto">
                <h3 class="titulo"> Horarios y precios </h3>
